...
# teraskula.com/service-control-bundle:$VERSION and teraskula.com/service-control-catalog:$VERSION.
IMAGE_TAG_BASE ?= prima101112/service-control-operator
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name service-control-builder
	$(CONTAINER_TOOL) buildx use service-control-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm service-control-builder
	rm Dockerfile.cross
