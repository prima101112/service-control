...
development is scafold by operator sdk, also some docs, helm chart, and examples creation is help by claude sonnet 4. 

~the kind of query
```from this CRD's could you create example applications simple and advance (using all custom parameters) using this image jfxs/hello-world```

i personaly choose jfxs/hello-world. and not touching the test for now. the github workflow is auto generated by operator sdk. thats why i choose operator SDK for every operator/controller i create.
